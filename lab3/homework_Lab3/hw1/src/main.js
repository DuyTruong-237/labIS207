...
const img1 = document.querySelectorAll(".ItemDrum1");
const img2 = document.querySelectorAll(".ItemDrum2");
const img3 = document.querySelectorAll(".ItemDrum3");
const img4 = document.querySelectorAll(".ItemDrum4");
const img5 = document.querySelectorAll(".ItemDrum5");
const img6 = document.querySelectorAll(".ItemDrum6");
const img7 = document.querySelectorAll(".ItemDrum7");
